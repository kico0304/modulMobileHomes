            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-xl-7">
                    <div class="block">
                        ...
                        <p style="background: linear-gradient(90deg, transparent, #fff);border-radius: 50px;" class="mb-4 pr-5">Zato što su naši objekti dimenziosani prema vašim stvarnim potrebama.</p>
